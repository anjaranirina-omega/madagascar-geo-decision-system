  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft dark:border-slate-800 dark:bg-slate-900">
        <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-500">
              Ces poids contrôlent les modèles inondation, sécheresse, glissement
              de terrain et cyclone. Ils sont appliqués lors du prochain
              lancement du pipeline de risque depuis la page Données.
            </p>
          </div>
          ...
          <button
            ...
            className="inline-flex h-11 items-center justify-center gap-2 rounded-xl border border-slate-300 px-4 text-sm font-bold text-slate-700 transition hover:bg-slate-50 disabled:opacity-60"
          >
            <RotateCcw size={17} />
            Réinitialiser tous
          </button>
        ...
        <div className="mb-5 rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm font-semibold text-blue-800">
          Modèle sélectionné : {selectedRiskOption?.label}. Les poids sont séparés
          entre la partie Aléa et la partie Risque.
        </div>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft dark:border-slate-800 dark:bg-slate-900">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
          ...
          global. Les poids spécifiques sont utilisés par les scripts des modèles
          inondation, sécheresse, glissement et cyclone lors du prochain pipeline
          ETL lancé depuis la page Données.
        </p>
      </div>
    </div>
  );
